...
function UserForm({ user, onClose, onSaved }) {
  const [f, setF] = useState({ name: user.name || '', pin: '', role: user.role || 'collector', can_collect: !!user.can_collect, can_import_statement: !!user.can_import_statement, can_view_reports: !!user.can_view_reports, can_view_dashboard: !!user.can_view_dashboard, company_ids: user.company_ids || [] })
  ...
  const save = async () => {
    ...
    await api.saveUser({ id: user.id, name: f.name.trim(), role: f.role, can_collect: f.can_collect, can_import_statement: f.can_import_statement, can_view_reports: f.can_view_reports, can_view_dashboard: f.can_view_dashboard, company_ids: f.company_ids, ...(f.pin ? { pin: f.pin } : {}) })
